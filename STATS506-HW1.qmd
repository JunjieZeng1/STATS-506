...
isPalindromic <- function(x){
  ...
  x_splited <- strsplit(x_char, NULL)
  x_reversed <- rev(x_splited[[1]])
  x_new <- paste(x_reversed, collapse = "")
  
  # Set return values
  reversed <- as.integer(x_new)
  isPalindromic <- x == reversed
  
  # Create return list
  return_list <- list(isPalindromic = isPalindromic, reversed = reversed)
